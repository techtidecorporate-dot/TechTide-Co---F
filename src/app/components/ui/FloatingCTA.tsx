...
// Floating CTA no longer animates; stays fixed at right edge
...
export function FloatingCTA() {
  ...
  return (
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40 h-[180px] w-[56px] flex items-center justify-center">
